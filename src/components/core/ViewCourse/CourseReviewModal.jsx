...
export default function CourseReviewModal({ setReviewModal }) {
  ...
  return (
    <div className="fixed inset-0 z-[1000] grid h-screen w-screen place-items-center overflow-auto bg-black/50 backdrop-blur-sm p-4 sm:p-6">
          ...
          >
            ...
            <div className="flex w-full flex-col space-y-2">
              ...
              <textarea
                ...
                className="form-style min-h-[100px] sm:min-h-[130px] w-full resize-none rounded-md p-2 text-sm sm:text-base"
              />
             ...
             <div className="mt-6 flex w-11/12 justify-center gap-x-4">
            <button
