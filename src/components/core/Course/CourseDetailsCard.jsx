...
//             toast.error("You are Instractore You can not buy the course");
//             return;
//         }
//         if(token){
...
//     return(
//         <div>
//             <img src={ThumbnailImage} alt="Thumbnail Img" className='max-h-[300px] min-h-[180px] w-[400px] rounded-xl' />
//             <div>
//                 Rs. {CurrentPrice}
//             </div>
